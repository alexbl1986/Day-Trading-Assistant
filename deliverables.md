...
| 4    | End-to-end prototype, deployed                                                                    | Live app: [https://day-trading-assistant.vercel.app/](https://day-trading-assistant.vercel.app/)                                  |
...
The real questions the trader asks, every one scoped to his actual positions; the portfolio is the lens, not the market in the abstract. Ground-truth answers to be filled in from the real source documents. *note: this was prepared on day 1 of the assignment when interviewing the trader. Later on when receiving transcripts from his actual workflow, and when scoping the prototype's coverage of his pain points, I pivoted the evaluation questions on tasks 5/6. 
